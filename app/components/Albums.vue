    ...
    <div v-else>
      <HorizontalScroll v-if="albums.length" :items="albums" :itemWidth="170">
        <template v-slot:default="slotProps">
          <figure>
            <img class="lazy" @click.prevent="select(slotProps.item)" src="data:image/gif;base64,R0lGODlhqgCqAAAAACH5BAEAAAAALAAAAACqAKoAAAICTAEAOw==" :data-src="slotProps.item.cover_medium" :alt="slotProps.item.title">
          </figure>
